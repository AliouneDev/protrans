  ...
  if (mysqli_num_rows($result) > 0) {?>
    ...
    <div class="container pos-rel">
      ...
      <div id="js-grid-masonry" class="cbp">
            ...
            <div class="col-md-4">
              <div class="cbp-item">
                <div class="blog-warp text-left">
                  <img src="assets/images/<?php echo $image_name; ?>" alt="" class="rounded">
                  <div class="meta-box"><a href="#"><?php echo $titre; ?></a> <span>/</span><?php echo $date_creation; ?></div>
                  <h4 class="h4-md mb-3"><a href="blog-single.html"><?php echo $auteur; ?></a>
                  </h4>
                  <p><?php echo $contenu; ?></p>
                  <a href="blog-single.html" class="btn-theme bg-navy-blue no-shadow">Learn More <i class="icofont-rounded-right"></i></a>
                </div>
              </div>
            </div>
        ...
        <?php 
              $row_cnt++;
              // Fermer la div de la ligne une fois que trois images et contenu ont été affichés
              if ($row_cnt % 3 == 0) {
                echo '</div>';
              }
            }
            // Fermer la div de la ligne si la boucle se termine sur une image et un contenu unique
            if ($row_cnt % 3 != 0) {
              echo '</div>';
            }
        ?>
