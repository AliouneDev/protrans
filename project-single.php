...
<body>
    ...
    <main id="body-content">
        ...
        if ($row = mysqli_fetch_assoc($res)) {
            // Récupérer le nom de toutes les images du projet
        ...
        <section class="bg-light-gray wide-tb-100 why-choose">
            ...
            <div class="container pos-rel">
                <div class="row align-items-center">
                    ...
                    <img src="assets/images/portfolio/<?php echo $first_image; ?>" alt="">
                    </div>
                    <!-- Icon Box -->
                        ...
                        <div class="icon-box-2">
                            <div class="media">
                                <div class="service-inner-content media-body">
                                    <h4 class="h4-md"> Details du projet</h4>
                                    <p><strong>Customer:</strong><?php echo $client;?></p>
                                    <p><strong>Category:</strong><?php echo $gesCategorie;?></p>
                                    <p><strong>Date:</strong><?php echo $date;?></p>
                                    <p><strong>Status:</strong><?php echo $statue ;?></p>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="team-box">
                <div class="team-thumb">
                    <img src="assets/images/portfolio/<?php echo $image; ?>" alt="" style="width: 300px;
    height: 300px;">
                </div>
            </div>
        </div>
