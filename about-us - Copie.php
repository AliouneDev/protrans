            ...
            <div class="container">
                ...
                <div class="d-inline-flex request-btn order-lg-last col p-0">
                    ...
                    <a class="btn-theme icon-left bg-navy-blue no-shadow align-self-center" href="#" role="button"
                        data-toggle="modal" data-target="#request_popup"><i class="icofont-list"></i><span
...
<?php include ('headerentete.php');?>
    ...
    <div class="slider bg-navy-blue bg-fixed pos-rel breadcrumbs-page">
        <div class="container">
            ...
            Rencontrez l’incroyable équipe derrière ce projet et apprenez-en plus sur notre façon de travailler.
            </div>
            
        </div>
        <img src="assets/images/impré2.jpg" alt="" data-bgposition="center center" style="width: 4000px;
    height: 700px;">
    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 wow fadeInLeft" data-wow-duration="0" data-wow-delay="0s">
                        <h2 class="mb-4 fw-7 txt-blue">
                            A propos <span class="fw-6 txt-orange">Protrans221</span>
                        </h2>

                        <p>PROTRANS est la concrétisation de plus d’une vingtaine d’années de dur labeur d’une
équipe professionnelle qui continue de relever les défis et de s’adapter aux réalités de
l’industrie.
Piliers de notre entreprise, nos collaborateurs de par leur savoir-faire sont essentiels pour
offrir un service de qualité à nos clients. </p>

                        <p>Notre mission est d’offrir à nos partenaires une expertise technique de pointe et une
vision locale non seulement dans le transport multimodal (air, mer et terre) mais
également dans le transit et la logistique en général, pour tous types de marchandises.</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 wow fadeInDown" data-wow-duration="0" data-wow-delay="0s">
                        <h1 class="heading-main">
                            <span>Notre Bonté</span>
                            Ce qui nous rends speciaux
                        </h1>
                    </div>
                    <!-- Heading Main -->
                        ...
                        <div class="icon-box-2">
                            <div class="media">
                                ...
                                <div class="service-inner-content media-body">
                                    <h4 class="h4-md">Un transport adapté qui allie savoir-faire ,qualité et sécurité</h4>
                                    <p>nous sommes déterminés à fournir un transport adapté de qualité supérieure, en combinant savoir-faire, qualité et sécurité pour offrir une expérience de transport exceptionnelle à nos clients.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 wow fadeInUp" data-wow-duration="0" data-wow-delay="0.2s">
                        <div class="icon-box-2">
                            <div class="media">
                                ...
                                <div class="service-inner-content media-body">
                                    <h4 class="h4-md">L'intégrité de la marchandise transportée</h4>
                                    <p>nous comprenons l’importance de l’intégrité de la marchandise transportée. Nous sommes déterminés à assurer que votre marchandise est transportée en toute sécurité et dans les délais impartis, sans subir de dommages ni de pertes.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 wow fadeInUp" data-wow-duration="0" data-wow-delay="0.4s">
                        <div class="icon-box-2">
                            <div class="media">
                                ...
                                <div class="service-inner-content media-body">
                                    <h4 class="h4-md">Assurance MTC des marchandises transportées</h4>
                                    <p>Notre équipe de professionnels expérimentés est formée pour travailler en étroite collaboration avec les clients pour comprendre leurs besoins et leur fournir des solutions sur mesure en matière d’assurance MTC. Nous sommes déterminés à fournir un service de qualité supérieure à chaque étape du processus, en veillant à ce que les clients soient informés et rassurés à chaque étape de la procédure d’assurance.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="pos-rel bg-light-theme">
            <div class="container-fluid">
                <div class="row align-items-center">
                <div class="col-lg-5 col-12 p-0" style="padding-left: 20px;">
                    <img src="assets/images/pourquoinouschoisir.jpg" class="w-100" alt="" style="width: 200;height: 300px;">
                </div>
                        ...
                        <div class="p-5 about-whoose">
                            ...
                            <ul class="list-unstyled icons-listing theme-orange w-half mb-0">
                                <li class="wow fadeInUp" data-wow-duration="0" data-wow-delay="0s"><i
                                        class="icofont-check"></i>Offrir des services à la clientèle respectueux de l’environnement
                                </li>
                                <li class="wow fadeInUp" data-wow-duration="0" data-wow-delay="0.1s"><i
                                        class="icofont-check"></i>Soyez un partenaire communautaire actif</li>
                                <li class="wow fadeInUp" data-wow-duration="0" data-wow-delay="0.2s"><i
                                        class="icofont-check"></i>Favoriser l’amélioration continue</li>
                                <li class="wow fadeInUp" data-wow-duration="0" data-wow-delay="0.3s"><i
                                        class="icofont-check"></i>Service de dédouanement et de conformité</li>
                                
                                <li class="wow fadeInUp" data-wow-duration="0" data-wow-delay="0.5s"><i
                                        class="icofont-check"></i>Maintenir des normes éthiques élevées</li>
                               
                                <li class="wow fadeInUp" data-wow-duration="0" data-wow-delay="0.7s"><i
                                        class="icofont-check"></i>Nous assurons une sécurité totale</li>
                            </ul>
                            <!-- Tracking Form -->
                        </div>
