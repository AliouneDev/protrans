...
<body>
    ...
    <main id="body-content">
        ...
        <?php $sql = "SELECT * FROM posts ORDER BY date_creation DESC LIMIT 1;";
...
if (mysqli_num_rows($result) > 0) {?>
            <div class="container pos-rel">
              ...
              // Afficher trois images et contenu par ligne
             
        ?>
                            <div class="col-md-12">
                           
                                <div class="text-left">
                                    <img src="assets/images/<?php echo $image_name; ?>" alt="" class="rounded mb-4">
                                    <div class="meta-box"><a href="#">Business</a> <span>/</span><?php echo $date_creation; ?>
                                    </div>
                                    <h4 class="h4-md mb-3 fw-7 txt-blue"><?php echo $titre; ?>
                                    </h4>
                                ...
                                <div class="commnets-reply">
                                    ...
                                    <div class="media pb-5">
                                        <img class="thumb rounded-circle" src="assets/images/team_2.jpg" alt="">
                                    ...
                                    <div class="media pb-5">
                                        <img class="thumb rounded-circle" src="assets/images/team_3.jpg" alt="">
                                        <div class="media-body">
                                            <div class="border-style d-md-flex justify-content-between">
                                    ...
                                    <div class="media pb-5">
                                        <img class="thumb rounded-circle" src="assets/images/team/team-2.jpg" alt="">
                                        <div class="media-body">
                                            <div class="border-style d-md-flex justify-content-between">
                                                <h4 class="h4-xs txt-orange">Anonymous</h4>
                                                <small class="txt-blue">September 11, 2018 at 7:33 am</small>
                    ...
                    <div class="col-md-12 col-lg-4">
                        ...
                        <aside class="sidebar-spacer row">
                            ...
                            <div class="sidebar-primary col-lg-12 col-md-6">
                                ...
                                <?php $sql = "SELECT * FROM posts ORDER BY date_creation DESC LIMIT 2" ;                               $result = mysqli_query($conn, $sql);
                                ?>
