   ...
   <?php include ('headerentete.php');?>
    ...
    <div class="slider bg-navy-blue bg-fixed pos-rel breadcrumbs-page">
        <div class="container">
            ...
            Notre réseau mondial et notre équipe à service complet de professionnels du fret aérien et du fret accéléré sont prêts à Aide.
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-6">
                        <h2 class="mb-4 fw-7 txt-blue wow fadeInLeft" data-wow-duration="0" data-wow-delay="0s">
                            Quality <span class="fw-6 txt-orange">and</span> Performance <br><span
                                class="fw-6 txt-orange">et au juste prix/span>
                        </h2>

                        <p class="wow fadeInLeft" data-wow-duration="0" data-wow-delay="0.2s">Utiliser énergiquement Marchés de niche axés sur l’équipe plutôt que sur les plates-formes à effet de levier. Restauration tactique monotone Penser « en dehors des sentiers battus » et obtenir des livrables techniquement solides.. </p>

                        <p class="wow fadeInLeft" data-wow-duration="0" data-wow-delay="0.4s">Se développer pleinement de manière convaincante a recherché des améliorations de processus grâce à des opportunités innovantes. Produire de manière crédible hautement des potentialités efficaces pour les compétences de base verticales. Maintenir rapidement la pandémie plutôt que des processus à faible risque à haut rendement.
...
<?php include ('nosservices.php'); ?>
        ...
        <?php include ('cequinousrendspeciaux.php');  ?>
