...
<body>
    ...
    $res = mysqli_query($conn, $sql);?>
        ...
        // Récupérer le nom de la première image
        $first_image = $images[0];
        $id = $row['id'];?>
                    <div class="cbp-item rounded design">
                        
                        <div class="gallery-link">
                            <a href="project-single.php?id=<?php echo $id;?>" class="txt-white"><i class="icofont-external-link"></i></a>
                        </div>
                        <a href="assets/images/portfolio/<?php echo $image_name; ?>" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assets/images/portfolio/<?php echo $first_image; ?>" alt="" style="width: 300px;
    height: 270px;">
                            </div>
