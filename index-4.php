            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="service-details.html">
                            <div class="icon-box-with-img bg-orange">
                                <img src="assets/images/icon-box-img-1.jpg" alt="">
                                <div class="text">
                                    Freight Forwarding
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <a href="service-details.html">
                            <div class="icon-box-with-img bg-orange">
                                <img src="assets/images/icon-box-img-2.jpg" alt="">
                                <div class="text">
                                    Road Freight
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <a href="service-details.html">
                            <div class="icon-box-with-img bg-orange">
                                <img src="assets/images/icon-box-img-3.jpg" alt="">
                                <div class="text">
                                    Car transportation
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row text-center mobile-100">
                    <div class="col-sm-12">
                        ...
                        <a href="#" class="ml-5 link-oragne icon-left play-video"><i class="icofont-play"></i> Watch Our
                            Short Video</a>
                    </div>
                    <div class="video-box">
                        <!-- close-video -->
